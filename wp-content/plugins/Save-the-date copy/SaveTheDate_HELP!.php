...
function create_save_the_date() {
    register_post_type( 'save_the_date',
        array(
            ...
            'public' => true,
            'menu_position' => 15,
            'supports' => array( 'title', 'comments', 'thumbnail', 'editor'),
            'taxonomies' => array( '' ),
...
function display_save_the_date_meta_box( $save_the_date ) {
    ...
    <tr>
        ...
        <tr>
            ...
            <input class = "ir" name="save_the_date_wedding_color03" value="<?php echo $wedding_color03; ?>" /></td>
        </tr>
        <tr>
...
add_action( 'save_post', 'add_save_the_date_fields');
